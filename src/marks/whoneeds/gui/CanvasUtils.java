...
import static marks.whoneeds.gui.GUIHandler.gc;
import static marks.whoneeds.gui.GUIHandler.stageH;
import static marks.whoneeds.gui.GUIHandler.stageW;
...
public class CanvasUtils {
	 ...
	 * @param canvasX the x-coordinate on the window
	 ...
	 * @param canvasY the y-coordinate on the window
	...
	public static void drawText(double x, double y, double height, String text, Color c) {
		...
		gc.setFill(c);
		gc.setFont(Font.font(4.0 * adjH / 3.0 + 2.0));
